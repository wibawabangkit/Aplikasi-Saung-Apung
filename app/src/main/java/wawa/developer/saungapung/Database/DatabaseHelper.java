package wawa.developer.saungapung.Database;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    //nama database
    public static final String DATABASE_NAME = "db_SaungApung";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("insert into " + TABLE_USER + " values ('admin@gmail.com','adminapung','Admin Saung Apung');");
    }
